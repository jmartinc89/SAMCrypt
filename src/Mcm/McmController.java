...
public class McmController implements Initializable {
    ...
    public void escribirHistorial(){
        ...
        if(tfOp3.getText().equals(""))
            historial = ("mcm( " + op1 + " , " + op2 + " ) = " + resul + "\n\n");
        else 
        {
            String op3 = tfOp3.getText();
            historial = ("mcm( " + op1 + " , " + op2 + " , " + op3 + " ) = " + resul + "\n\n");
        }
                    ...
                    if(auxOp3()) // Op3 activo
                    {
                        ...
                        if(enc)
                        {
                            ...
                            if(enc)
                            {
                                ...
                                if(enc) // Op3 correcto
                                {
                                    String r_aux = mcml.mcm(op1, op2);
                                    resul = mcml.mcm(r_aux, op3);
                                    op3 = validar.separadorMiles(op3, this.base);
                                    tfOp3.setText(op3.toUpperCase());
                                }
                                else
                                    error("Para calcular el mcm los operandos tienen que ser números enteros.");
                            }
                            else
